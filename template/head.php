...
<head>
        ...
        <meta name='description' content="<?php setContent(
                                                        'Bienvenue sur TRETRELLO, le n°1 en matière de gestion de projet et Kanbans !',
                                                        'L\'inscription à TRETRELLO, c\'est par ici !',
                                                        'Modifiez vos informations personnelles sur cette page',
                                                        'Visualisez vos projets en cours',
                                                        'Créez de nouveaux projets',
                                                        'Visualisez vos projets terminés'
                                                ) ?>">
