...
<nav class=" col-lg-8 d-none d-lg-block">
    <ul class="d-flex text-black-50 fw-bold justify-content-between fs-5 mt-3 align-items-center">
        ...
        <li><a class="link-<?= isset($_GET['page']) && $_GET['page']== "profil" ? "secondary" : "primary"?>"<?= isset($_GET['page']) && $_GET['page']== "encours" ? "title='Lien actif'" : ""?> href="../pages/profil.php?page=profil" ><img class ="userImage" src=" <?= isset($_SESSION['photo']) && !empty($_SESSION['photo']) ? './../upload/'.$_SESSION['photo'] : "./../style/assets/defaultUser.webp"  ?>" alt="">
</a></li>
...
<ul class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
    ...
    <li><a class="dropdown-item" href="../pages/profil.php?page=profil"><img class ="userImage" src=" <?= isset($_SESSION['photo']) && !empty($_SESSION['photo']) ? './../upload/'.$_SESSION['photo'] : "./../style/assets/defaultUser.webp"  ?>" alt="">
</a></li>
