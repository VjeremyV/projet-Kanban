...
?><p>Bonjour <?= $_SESSION['prenom'] . " " . $_SESSION['nom'] ?></p><?php
    ...
    <form action="" method="POST" class="d-flex justify-content-end align-items-center mb-3">
        <div class="form-floating mx-2 h-25">
            <input class="form-control m-1" type="text" name="mail" placeholder="mail" />
            <label class="form-label m-1" for="mail">Votre email</label>
        </div>

        <div class="form-floating mx-2">
            <input class="form-control m-1" type="password" name="mdp" placeholder="pass" />
